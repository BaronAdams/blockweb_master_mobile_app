...
export default function CreateProfileFormScreen() {
  ...
  const onSubmit = () => {
    ...
    router.dismissTo('/(tabs)/profiles')
  }
  ...
  return (
    <View style={{ flex: 1, backgroundColor: background }}>
      ...
      <ScrollView contentContainerStyle={{ padding: 20, paddingTop: 4, paddingBottom: 60, gap: 20 }}>
        <View style={{ flexDirection: 'row', alignItems: 'center', gap: 10 }}>
          ...
          >
            <meta.icon color={meta.color} size={18} strokeWidth={1.8} />
          </View>
              ...
              <View style={{ flexDirection: 'row', flexWrap: 'wrap', gap: 8 }}>
                {DAYS.map(d => {
                  ...
                  return (
                    ...
                    >
                      <Text style={{ fontSize: 12, fontWeight: '600', color: active ? primaryForeground : undefined }}>
                        {tc(d.key)}
                      </Text>
                    </Pressable>
                  )
